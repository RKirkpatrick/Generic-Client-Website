...
app.post(
	...
	(req, res) => {
		...
		// Google sheet with spreadsheetId needs to be shared with a google service account
		// let spreadsheetId = '';
		// let range = 'A1:C1';
...
// Note: This `frontFacingNodeServer1` must match with `/firebase.json` rewrites rule.
exports.frontFacingNodeServer1 = functions.https.onRequest(app);
